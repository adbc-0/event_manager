    ...
    return (
        <div className="grid grid-cols-1 items-center auto-rows-min md:auto-rows-[1fr_1fr_1fr]">
            ...
            <dialog
                ...
                className="bg-gray-100 bg-clip-padding backdrop-filter backdrop-blur-3xl bg-opacity-10 p-0 rounded-md max-w-sm border border-black"
                open={!username}
            >
                <div className="border border-white/25 rounded-md p-6">
                    ...
                    >
                        ...
                        <p className="text-sm">
                            use the same username across devices
                        </p>
                        <input
                            ref={nameInputRef}
                            className="border border-black my-6 py-2 block m-auto text-center rounded-md bg-zinc-900 bg-clip-padding backdrop-filter backdrop-blur-3xl bg-opacity-40"
